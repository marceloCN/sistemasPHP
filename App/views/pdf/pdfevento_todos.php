...
<?php
if ($datos_funcionario != null) {
    $cant = 0;
    while ($cant < count($datos_funcionario)) {
?>

        <body>
            <img src="<?= constant('URL') ?>/fondo.jpg" alt="Imagen izquierda" class="imagen">
            <div style=" font-family: serif ;">
                ...
                <div class=" " style="margin: 2px; border: 1px solid #2196f3; font-size:13px; margin-bottom: 15px">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="" width="90%" style="margin: 10px;">
                                <div class="" style="padding: 4px; margin: 5px; text-align: center;"><?= $datos_funcionario[$cant]['cargo'] ?></div>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="" width="58%" style="margin: 10px;">
                                <div class="" style="padding: 4px; margin: 2px; font-size:14px ; text-align: center;"><?= $datos_funcionario[$cant]['nombre'] ?> </div>
                            </td>
                            ...
                            <td class="" width="30%" style="margin: 10px;">
                                <div class="" style="padding: 4px; margin: 2px; font-size:14px ; text-align: center;"><?= $datos_funcionario[$cant]['ci'] ?></div>
                            </td>
                        <tr>
                    </table>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="" width="30%" style="margin: 10px;">
                                <div class="" style="padding: 4px; margin: 2px;  font-size:14px ; text-align: center;"><?= $datos_funcionario[$cant]['totalretrazo'] ?> minutos</div>
                            </td>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="" width="20%" style="margin: 10px;">
                                <div class="" style="padding: 4px; margin: 2px;  font-size:14px ; text-align: center;"><?= $datos_funcionario[$cant]['fechainicio'] ?></div>
                            </td>
                            <td class="" width="10%" style="margin: 10px;">
                                <div class="  " style="padding: 4px; margin: 2px;  background:#e8eaf6 ;color:#01579b ;font-weight: bold;">Hasta: </div>
                            </td>
                            <td class="" width="40%" style="margin: 10px;">
                                <div class="" style="padding: 4px; margin: 2px;  font-size:14px ; text-align: center;"><?= $datos_funcionario[$cant]['fechafin'] ?></div>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="" style="margin: 2px; border: 1px solid #2196f3; font-size:13px; margin-bottom: 5px">
                    <table width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <?php
                            if ($datos_funcionario[$cant]['eventos'] != null) {
                                foreach ($datos_funcionario[$cant]['eventos'] as $calculo) {
                            ?>
                                    <tr>
